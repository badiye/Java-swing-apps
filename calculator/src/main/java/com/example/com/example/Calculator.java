...
public class Calculator extends JFrame implements ActionListener {
    ...
    class RoundedButtonTwo extends JButton {
        public RoundedButtonTwo(String label) {
            super(label);
            setFocusPainted(false);
            setContentAreaFilled(false);
            setBorderPainted(false);
    ...
    public Calculator() {
        ...
        for (int i = 1; i < 10; i++) {
            numberButtons[i] = new RoundedButtonTwo(String.valueOf(i));
            numberButtons[i].setFont(new Font("Arial", Font.PLAIN, 24));
            numberButtons[i].setBackground(Color.BLACK);
            numberButtons[i].setForeground(Color.WHITE);
            numberButtons[i].addActionListener(this);
        }
        numberButtons[0] = new RoundedButton("0");
